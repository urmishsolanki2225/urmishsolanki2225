...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/admin//assets/css/libs.min.css')}}">
    <!-- Custom Css -->
    <link rel="stylesheet" href="{{asset('public/admin/assets/css/logik.css?v=1.0.0')}}">
</head>
<body class=" ">
    <!-- loader Start -->
    <div id="loading">
                    ...
                    <div class="col-lg-5 col-md-8">
                        <div class="card" style="transform: translate(0px, 25px);">
                            <div class="card-header">
                                <a href="{{asset('public/admin/dashboard/index.html')}}" class="navbar-brand d-flex align-items-center">
                                    <!--Logo start-->
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <button class="btn btn-primary text-white w-100">{{ __('Login') }}</button>
                                    <p class="my-3 text-start h6">or sign in with other accounts?</p>
                                    <div class="d-flex justify-content-center">
                                        <ul class="list-group list-group-horizontal list-group-flush">
                                            <li class="list-group-item border-0 pe-2">
                                                <a href="#"><img src="{{asset('public/admin/assets/images/brands/01.png')}}" class="img-fluid avatar avatar-30 avatar-rounded" alt="img60"></a>
                                            </li>
                                            <li class="list-group-item border-0 pe-2">
                                                <a href="#"><img src="{{asset('public/admin/assets/images/brands/02.png')}}" class="img-fluid avatar avatar-30 avatar-rounded" alt="gm"></a>
                                            </li>
                                            <li class="list-group-item border-0 pe-2">
                                                <a href="#"><img src="{{asset('public/admin/assets/images/brands/03.png')}}" class="img-fluid avatar avatar-30 avatar-rounded" alt="im"></a>
                                            </li>
                                            <li class="list-group-item border-0 pe-2">
                                                <a href="#"><img src="{{asset('public/admin/assets/images/brands/04.png')}}" class="img-fluid avatar avatar-30 avatar-rounded" alt="li"></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <p class="text-center text-dark mb-0">
                                        Don’t have an account? <a href="{{url('/register')}}" class="text-secondary text-decoration-underline">Click here to sign up.</a>
                                    </p>
                                </form>
                            </div>
                        </div>
                        <div class="auth-img">
                            <img src="{{asset('public/admin/assets/images/auth/01.png')}}" alt="page" class="signin-outer-img w-25">
                            <img src="{{asset('public/admin/assets/images/auth/02.png')}}" alt="robot" class="signin-robot-img w-25">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="{{asset('public/admin/assets/js/libs.min.js')}}"></script>
    <!-- Dashboard Charts JavaScript -->
    <script src="{{asset('public/admin/assets/js/charts/dashboard.js')}}"></script>
    <script src="{{asset('public/admin/assets/js/charts/apexcharts.js')}}"></script>
    <!-- fslightbox JavaScript -->
    <script src="{{asset('public/admin/assets/js/fslightbox.js')}}"></script>
    <!-- app JavaScript -->
