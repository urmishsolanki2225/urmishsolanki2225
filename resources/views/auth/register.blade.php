    ...
    <div class="wrapper">
        <div class="signup-robot">
                    ...
                    <div class="col-md-5">
                        <div class="card" style="transform: translate(0px, 25px);">
                            <div class="card-header">
                                <a href="{{asset('public/admin/dashboard/index.html')}}" class="navbar-brand d-flex align-items-center justify-content-center">
                                    <!--Logo start-->
                            ...
                            <div class="card-body">
                                <h5 class="text-center mb-2">Welcome aboard, sign in and get started.</h5>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <ul class="list-group list-group-horizontal list-group-flush">
                                            <li class="list-group-item border-0 pe-2">
                                                <a href="#"><img src="{{asset('public/admin/assets/images/brands/01.png')}}" class="img-fluid avatar avatar-30 avatar-rounded" alt="fb"></a>
                                            </li>
                                            <li class="list-group-item border-0 pe-2">
                                ...
                                <div class="new-account text-center mt-2">
                                    <p class="mb-0 text-dark">Already have an Account <a class="text-secondary text-decoration-underline" href="{{asset('public/admin/dashboard/auth/sign-in.html')}}">{{ __('Register') }}</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="auth-img">
                ...
                <img src="{{asset('public/admin/assets/images/auth/03.png')}}" alt="bulp" class="signup-right-img w-25">
            </div>
        </div>
    </div>
